...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (Platform.OS === 'android') {
      console.log("안드로이드 알림 채널 설정");
      console.log("알림 채널 값 : ", Notifications.getNotificationChannelsAsync());
  ...
  return (
    ...
    <Provider store={store}>
      ...
      <View style={styles.debugContainer}>
          ...
          {/* <Text>Notification: {notification ? JSON.stringify(notification) : 'No notification'}</Text> */}
